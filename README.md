# NBResearch 
this repository is for my research about netbios over tcp protocol, and contains all sorts of external resources, in order to help me migrate the work faster from one environment to another.
# Motive
